        ...
        <Container maxWidth="md" className="flex flex-col items-center justify-center min-h-screen">
            ...
            <Box className="mt-8 text-center">
                ...
                <Typography variant="body1" align="center" className="mt-4 text-gray-600">
                    ...
                    - Completed the file system and demo pages, enabling test users to upload, parse, and download DWG files.<br />
                    - Focusing on <strong> Preprocessing JSON files </strong> generated by LibreDWG (implemented in the JavaScript frontend).<br />
                </Typography>
            </Box>
