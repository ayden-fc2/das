        ...
        <div className={`${expanded? "opacity-100" : "opacity-80 h-6"} rounded transition-all duration-300 ease-in-out fixed top-0 left-1/2 -translate-x-1/2 bg-white shadow-md p-2 flex justify-center gap-4 z-50`}>
            ...
            {expanded && (
                <>
                    ...
                    <Button variant="contained" color="primary" onClick={handleShowCurComChange}>Blocks Overview</Button>
                    <Button variant="contained" color="success" onClick={handleShowRelayChange}>Graphical Structure Analysis</Button>
