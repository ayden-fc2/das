...
public interface DwgService {
    long genAnalysis(int userId, String projectName, String dwgPath, int isPublic);
    ...
    Boolean uploadDwgByOrgId(String dwgPath, Long orgId, Long userId, Long projectId);
}
